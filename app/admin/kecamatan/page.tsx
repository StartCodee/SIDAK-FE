        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex items-center space-x-2">
                    <Button variant="outline" size="sm" onClick={() => editKecamatan(Number(row.getValue()))}>Edit</Button>
                    <Button variant="destructive" onClick={() => deleteKecamatan(Number(row.getValue()))} size="sm">Delete</Button>
                </div>
            ),
        },
    ];
                                ...
                                <div className="ms-2">
                                    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                                        <DialogTrigger asChild>
                                            <Button variant="outline" onClick={() => setIsDialogOpen(true)}>Tambah Kecamatan</Button>
                                        </DialogTrigger>
                                        <DialogContent className="sm:max-w-[425px]">
                                            <form action="" method="dialog" onSubmit={(kecamatan.id == 0) ? createKecamatan : updateKecamatan}>
                                                <DialogHeader>
