...
const menuGroups = [
	{
		...
		menuItems: [
			...
			},
			{
				...
				label: 'Input Data Harga',
				route: '/admin/input-data-harga',
			},
			{
				icon: (
					<svg
				...
				label: 'Input Data Neraca',
				route: '/admin/input-data-neraca',
			},
			{
				icon: (
					<svg
			...
			// },
			{
				...
				children: [
					...
					},
					{
						...
						route: '/admin/commodity-management',
					},
					{
						icon: (
							<svg
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
	...
	return (
		<ClickOutside onClick={() => setSidebarOpen(false)}>
			<aside
				className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#37B5FE] duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
					}`}
			>
				{/* <!-- SIDEBAR HEADER --> */}
