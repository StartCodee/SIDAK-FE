      ...
      <div className="flex gap-10 w-full">
        <div className="  justify-center" style={{ flex: '5' }}>
          ...
          <div className="flex gap-3 mt-5">
            <CardDataStats bg="#6FCEB9" title="Total views" total="$3.456K" rate="0.43%" levelUp>
              <svg
            ...
            <CardDataStats bg="#F5A851" title="Total Profit" total="$45,2K" rate="4.35%" levelUp>
              <svg
                className="fill-primary dark:fill-white"
                width="20"
                height="22"
            ...
            <CardDataStats bg="#DD5C5C" title="Total Product" total="2.450" rate="2.59%" levelUp>
              <svg
                className="fill-primary dark:fill-white"
                width="22"
                height="22"
